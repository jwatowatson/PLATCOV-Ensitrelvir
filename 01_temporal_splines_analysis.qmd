...
model_settings$Niter = 4000/20
model_settings$Nwarmup = 2000/20
model_settings$Nthin = 4/4
...
```{r}
if(RUN_MODELS){
  system(paste('Rscript --vanilla run_models_local_old.R',intervention))
}
```
...
```{r}
resDir <- "Rout/01_Rout_temporal_splines_analysis_epoch" # "Rout/01_Rout_temporal_splines_analysis_variants" 
