...
```{r}
#Ensitrelvir vs NSD
analysed_data <- temp_dat_for_plot %>% filter(Trt != "Nirmatrelvir + Ritonavir")
...
```{r}
#Nirmatrelvir vs NSD
analysed_data <- temp_dat_for_plot %>% filter(Trt != "Ensitrelvir")
...
analysed_data <- temp_dat_for_plot %>% filter(Trt != "No study drug")
...
analysed_data <- temp_dat_for_plot %>% mutate(rangrp = if_else(Trt == "No study drug", rangrp, "Treated"))
