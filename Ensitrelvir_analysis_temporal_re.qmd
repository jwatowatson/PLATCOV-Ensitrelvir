...
```{r load_data}
intervention = 'interim_all' ; ref_arm = 'No study drug'; study_threshold = 1.2
```
...
```{r}
png(paste0("Plots/meta_analysis_effects_", intervention,"_", nperiod, "_periods_2.png"), width = 8, height = 5, unit = "in", res = 300)
