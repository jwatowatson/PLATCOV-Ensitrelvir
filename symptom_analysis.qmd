...
sympt_dat <- merge(sympt_dat, platcov_dat[,c("ID","Trt", "Rand_date", "mITT")], by.x = "Label", by.y = "ID")
...
```{r}
fname <- paste0("Plots/", intervention, "symptom_surv_plot.pdf")
...
```{r}
other_symptom_library <- read.csv("Analysis_Data/other_symptoms_ensitrelvir_v2.0_EB.csv")
